...
public class IngameState : BonfireGameState
{
    ...
    public static void TryGenerate(int chance, Func<bool> generator, int attempts = 10)
    {
        if (Utils.GetRandomInt(0, 101) >= chance) return;
    ...
    public void RandomPlantSpawner() =>
        TryGenerate(24, () =>
        {
